...
<div class="content">
    ...
    <div class="form-group">
        ...
        <input type="hidden" name="hari" value="<?php echo $data['hari']; ?>">
    </div>

    <!-- Jam Mulai (non-editable) -->
    <div class="form-group">
        <label for="jamMulai">Jam Mulai</label>
        <input type="time" class="form-control" id="jamMulai" name="jamMulai" required value="<?= $data['jam_mulai'] ?>" disabled>
        <input type="hidden" name="jamMulai" value="<?= $data['jam_mulai'] ?>">
    </div>

    <!-- Jam Selesai (non-editable) -->
    <div class="form-group">
        <label for="jamSelesai">Jam Selesai</label>
        <input type="time" class="form-control" id="jamSelesai" name="jamSelesai" required value="<?= $data['jam_selesai'] ?>" disabled>
        <input type="hidden" name="jamSelesai" value="<?= $data['jam_selesai'] ?>">
    </div>
