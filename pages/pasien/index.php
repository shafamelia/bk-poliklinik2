                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" value="<?php echo $data['no_ktp'] ?>" readonly>
                                    </td>
                                    <td><?php echo $data['no_hp'] ?></td>
                                    <td>
                                        <input type="text" class="form-control" value="<?php echo $data['no_rm'] ?>" readonly>
                                    </td>
                                    <td>
                                                    ...
                                                    <form action="pages/pasien/updatePasien.php" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="no_rm" 
                                                                name="no_rm" value="<?php echo $data['no_rm'] ?>" readonly>
                                                        </div>
