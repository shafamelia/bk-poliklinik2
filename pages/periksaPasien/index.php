                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="pages/periksaPasien/periksaPasien.php"
                                                            ...
                                                            <!-- Harga Konsultasi -->
                                                            <div class="form-group">
                                                                <label for="consultationPrice">Harga Konsultasi</label>
                                                                <input type="text" class="form-control" id="consultationPrice" name="consultationPrice" value="150000" readonly>
                                                            </div>

                                                            <!-- Dropdown Obat -->
                                                            <div class="form-group mb-3">
                                                                <label>Obat</label>
                                                                <select class="select2" multiple="multiple" data-placeholder="Pilih Obat" style="width: 100%;" name="obat[]" onchange="hitungTotal()">
                                                                    <?php 
                                                                        require 'config/koneksi.php';
                                                                        $getObat = "SELECT * FROM poli_bk.obat";  // Query untuk ambil harga obat
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="totalHarga" name="totalHarga" value="150000" readonly>
                                                            </div>
...
<script>
    ...
    function hitungTotal() {
        var totalHarga = 150000; // Harga konsultasi awal
    ...
    // Tambahkan event listener untuk menghitung total harga saat obat dipilih
