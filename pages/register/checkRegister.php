<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $no_ktp = $_POST['no_ktp'];
        $alamat = $_POST['alamat'];
        $password = $_POST['password']; // Tidak menggunakan MD5 di sini
        $no_hp = $_POST['no_hp'];
        ...
        if (mysqli_num_rows($queryCekKTP) > 0) {
            ...
            if (mysqli_num_rows($query) < 1) {
                ...
                // Jika sudah ada data, ambil nomor RM terakhir dan buat nomor RM baru
                ...
                // Insert data pasien dengan nomor RM baru
